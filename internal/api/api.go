...
func Mount(srv *mattrax.Server) {
	...
	rAuthed.HandleFunc("/{tenant}/device/{udid}", Device(srv)).Methods(http.MethodGet, http.MethodPatch, http.MethodOptions).Name("/devices/:id")
	...
	rAuthed.HandleFunc("/{tenant}/group/{gid}", Group(srv)).Methods(http.MethodGet, http.MethodPatch, http.MethodOptions).Name("/groups/:id")
	...
	rAuthed.HandleFunc("/{tenant}/policy/{pid}", Policy(srv)).Methods(http.MethodGet, http.MethodPatch, http.MethodOptions).Name("/policies/:id")
